-- foret_automne : reconstruit le document en calques dans Aseprite
...
local defs = {
  ...
  { name = "3_canopy", dir = "03_canopy", static = false }
}

local spr = Sprite(W, H, ColorMode.RGB)
spr.filename = app.fs.joinPath(base, "foret_automne.aseprite")
