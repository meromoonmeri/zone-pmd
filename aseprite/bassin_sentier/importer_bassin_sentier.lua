-- bassin_sentier : reconstruit le document en calques dans Aseprite
...
local defs = {
  ...
  { name = "4_Objects Under", dir = "04_objects_under", static = false },
  { name = "5_Objects", dir = "05_objects", static = false },
  { name = "7_Fringe", dir = "07_fringe", static = true }
}

local spr = Sprite(W, H, ColorMode.RGB)
spr.filename = app.fs.joinPath(base, "bassin_sentier.aseprite")
