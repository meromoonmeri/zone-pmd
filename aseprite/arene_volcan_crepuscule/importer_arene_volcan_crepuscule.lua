-- arene_volcan_crepuscule : reconstruit le document en calques dans Aseprite
...
local defs = {
  ...
  { name = "1_River", dir = "01_river", static = false },
  ...
  { name = "5_Objects", dir = "05_objects", static = true },
  { name = "7_Fringe", dir = "07_fringe", static = true }
}

local spr = Sprite(W, H, ColorMode.RGB)
spr.filename = app.fs.joinPath(base, "arene_volcan_crepuscule.aseprite")
